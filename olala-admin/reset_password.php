...
if(isset($_POST['forgot_user_email'])) {
	...
	if($db->RowCount>0) {
		...
		$message = 'Chào '.$rows[0]['user_name'].',<br/><br/>'.
				...
				'-----<br/><font face="arial, helvetica, sans-serif" style="color: #3b699a; font-weight: bold;"><a style="color: #3b699a; font-weight: bold;" href="http://olala-team.com">Olala-3W | Olala Team</a></font>';
